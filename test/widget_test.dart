...
Widget _buildTestApp({
  ...
  return ProviderScope(
    child: MaterialApp(
      theme:
          theme ??
          AppTheme.lightTheme.copyWith(extensions: [AppThemeExtension.light]),
      home: AppBaseLayout(currentPath: currentPath, child: child),
    ),
  );
}
...
void main() {
  ...
  group('Responsive AppBaseLayout tests', () {
    testWidgets('renders AppBottomNavigation on small screens (< 640dp)', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        _buildTestApp(child: const Scaffold(body: Text('Content on Mobile'))),
      );
    ...
    testWidgets('renders AppSideNavigation on large screens (>= 640dp)', (
      WidgetTester tester,
    ) async {
      ...
      await tester.pumpWidget(
        _buildTestApp(child: const Scaffold(body: Text('Content on Desktop'))),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets(
      ...
      (WidgetTester tester) async {
        ...
        await tester.pumpWidget(
          _buildTestApp(child: const Scaffold(body: Text('Resizable Content'))),
        );
        await tester.pumpAndSettle();
    ...
    testWidgets('nav items have accessible icons, labels, and tooltips', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(1200, 800);
      tester.view.devicePixelRatio = 1.0;
      ...
      await tester.pumpWidget(
        _buildTestApp(child: const Scaffold(body: Text('Accessible Nav'))),
      );
      await tester.pumpAndSettle();
      ...
      expect(find.byTooltip('Switch to Dark appearance mode'), findsOneWidget);
    ...
    testWidgets('nav selection updates based on currentPath', (
      WidgetTester tester,
    ) async {
      tester.view.physicalSize = const Size(400, 800);
      tester.view.devicePixelRatio = 1.0;
  ...
  group('Simple Nav Pages render properly', () {
    ...
    testWidgets('BooksPage renders with library items and filter chips', (
      tester,
    ) async {
      await tester.pumpWidget(
        const ProviderScope(child: MaterialApp(home: BooksPage())),
      );
      await tester.pumpAndSettle();
    ...
    testWidgets('ProfilePage renders user card and sign out option', (
      tester,
    ) async {
      await tester.pumpWidget(
